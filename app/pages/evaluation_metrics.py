...
def main():
    ...
    st.markdown("""
        ...
        - **Interpretability:** With an RMSE of 9.68 years, the ResNet50 model's predictions are, on average, within approximately 9.6
    8 years of the actual age.
    ...
    st.markdown("""
        ...
        **Note:** Please ensure these image files are present in the `outputs/plots/` directory for them to display correctly.
    """)
    ...
    """)
    st.image("outputs/plots/cnn_training_plot.png", caption="CNN Training and Validation Loss")
    ...
    """)
    st.image("outputs/plots/resnet_training_plot.png", caption="ResNet Training and Validation Loss")
    ...
    """)
    st.image("outputs/plots/cnn_prediction_plot.png", caption="CNN Predictions vs. Actual Age")
    ...
    """)
    st.image("outputs/plots/resnet_prediction_plot.png", caption="ResNet Predictions vs. Actual Age")
